...
const styles = StyleSheet.create({
  ...
  scanBody: { color: colors.muted, fontSize: 10, lineHeight: 15 },
  scanRetry: {
  ...
  scanHeaderMeta: { color: colors.green, fontSize: 10, fontWeight: "700" },
  staleText: { color: colors.amber },
  scanNote: { color: colors.muted, fontSize: 9, lineHeight: 13 },
  scanRow: {
    alignItems: "center",
    backgroundColor: colors.card,
    borderColor: colors.line,

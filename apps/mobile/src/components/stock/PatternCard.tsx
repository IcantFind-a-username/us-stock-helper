...
const styles = StyleSheet.create({
  ...
  signalLabel: { color: colors.muted, fontSize: 11, fontWeight: "700" },
  ...
  method: { color: colors.muted, fontSize: 11, lineHeight: 13 },
  ...
  patternName: { color: colors.ink, fontSize: 11, fontWeight: "700" },
  patternStatus: { fontSize: 11, fontWeight: "900" },
  ...
  context: { color: colors.muted, fontSize: 11, lineHeight: 15 },
  risk: { backgroundColor: colors.redSoft, borderRadius: radius.sm, color: colors.red, fontSize: 11, fontWeight: "700", lineHeight: 15, overflow: "hidden", padding: spacing.sm },
});

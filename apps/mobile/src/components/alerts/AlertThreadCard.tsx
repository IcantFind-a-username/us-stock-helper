...
const styles = StyleSheet.create({
  ...
  freshness: { color: colors.muted, fontSize: 11, fontWeight: "800" },
  ...
  summary: { color: colors.muted, fontSize: 11, lineHeight: 15 },
  metaRow: { flexDirection: "row", justifyContent: "space-between" },
  meta: { color: colors.ink, fontSize: 11, fontWeight: "800" },
  adviser: { color: colors.purple, fontSize: 11, fontWeight: "800" },
  evidence: {
    alignItems: "flex-end",

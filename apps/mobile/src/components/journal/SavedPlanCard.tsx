...
const styles = StyleSheet.create({
  ...
  entry: { color: colors.muted, fontSize: 11, fontWeight: "800" },
  metrics: { flexDirection: "row", justifyContent: "space-between" },
  metricLabel: { color: colors.muted, fontSize: 11 },
  metricValue: { color: colors.ink, fontSize: 11, fontWeight: "900", marginTop: 2 },
  warning: { color: colors.amber, fontSize: 11, fontWeight: "800" },
});

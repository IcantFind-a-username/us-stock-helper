...
const styles = StyleSheet.create({
  ...
  riskBadgeText: { color: colors.red, fontSize: 9, fontWeight: "900" },
  grid: { flexDirection: "row", flexWrap: "wrap", gap: spacing.sm },
  metric: { backgroundColor: colors.background, borderRadius: radius.sm, minWidth: "46%", padding: spacing.sm },
  metricLabel: { color: colors.muted, fontSize: 8, fontWeight: "700" },
  metricValue: { color: colors.ink, fontSize: 10, fontVariant: ["tabular-nums"], fontWeight: "900", lineHeight: 14, marginTop: 2 },
  logic: { backgroundColor: colors.blueSoft, borderRadius: radius.sm, gap: 3, padding: spacing.sm },
  logicTitle: { color: colors.blue, fontSize: 9, fontWeight: "900" },
  logicBody: { color: "#3B5F91", fontSize: 9, lineHeight: 14 },
  cancel: { gap: 3 },
  cancelTitle: { color: colors.ink, fontSize: 10, fontWeight: "900" },
  cancelBody: { color: colors.muted, fontSize: 9, lineHeight: 14 },
  shortRisk: { backgroundColor: colors.redSoft, borderRadius: radius.md, gap: 4, padding: spacing.sm },
  shortTitle: { color: colors.red, fontSize: 10, fontWeight: "900" },
  shortFacts: { flexDirection: "row", flexWrap: "wrap", gap: spacing.sm },
  shortFact: { color: colors.ink, fontSize: 9, fontVariant: ["tabular-nums"], fontWeight: "800" },
  shortWarning: { color: colors.red, fontSize: 9, fontWeight: "700", lineHeight: 13 },
  warning: { color: colors.red, fontSize: 9, fontWeight: "700", lineHeight: 14 },
  snapshot: { color: colors.muted, fontSize: 8, fontWeight: "600" },
});

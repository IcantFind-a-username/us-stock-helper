...
const styles = StyleSheet.create({
  ...
  caption: { color: colors.muted, fontSize: 9, fontWeight: "600" },
  ...
  preferenceDetail: { color: colors.muted, fontSize: 8, fontWeight: "600", marginTop: 2 },
  preferenceDetailSelected: { color: "#3B5F91" },
  guardrail: { backgroundColor: colors.amberSoft, borderRadius: radius.sm, color: "#7A5208", fontSize: 9, fontWeight: "700", lineHeight: 14, overflow: "hidden", padding: spacing.sm },
});

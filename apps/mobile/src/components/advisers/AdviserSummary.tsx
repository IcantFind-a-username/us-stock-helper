...
const styles = StyleSheet.create({
  ...
  initials: { color: colors.card, fontSize: 11, fontWeight: "900" },
  nameWrap: { flex: 1, minWidth: 0 },
  name: { color: colors.ink, fontSize: 11, fontWeight: "900" },
  focus: { color: colors.muted, fontSize: 11, fontWeight: "600", marginTop: 1 },
  direction: { fontSize: 11, fontWeight: "900" },
  thesis: { color: colors.ink, fontSize: 11, lineHeight: 15 },
  counter: { color: colors.muted, fontSize: 11, lineHeight: 14 },
  confidence: { color: colors.blue, fontSize: 11, fontWeight: "800" },
});
